    ...
    >
      ...
      <div className="container-custom relative z-10">
        <nav className="flex items-center justify-between">
                    ...
                    >
                      <div className="py-2">
                        {item.submenu.map((subItem, index) => (
                          <span
                            key={subItem.name}
                            className="block px-4 py-2.5 text-sm text-secondary-700 hover:text-primary-700 hover:bg-primary-50 transition-colors duration-150 cursor-pointer"
          ...
          {/* CTA Button - Desktop */}
          <span
            className={`hidden lg:inline-flex items-center gap-2 cursor-pointer transition-colors duration-300 ${
              isScrolled
                      ...
                      >
                        <div className={`ml-4 mt-2 space-y-1 border-l-2 ${
                          ...
                          {item.submenu.map((subItem) => (
                            <span
                              key={subItem.name}
                              className={`block px-4 py-2 text-sm rounded-lg transition-all duration-200 cursor-pointer ${
                                isScrolled
