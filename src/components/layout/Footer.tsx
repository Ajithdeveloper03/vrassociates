...
import { companyInfo, navigation, services } from '../../data/siteData';
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <span
                    className="text-secondary-400 hover:text-white hover:pl-1 transition-all duration-200 text-sm inline-flex items-center gap-1 cursor-pointer"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.slice(0, 6).map((service) => (
                <li key={service.id}>
                  <span
                    className="text-secondary-400 hover:text-white transition-colors duration-200 text-sm inline-flex items-center gap-1 cursor-pointer"
                  >
              ...
              <li>
                <span
                  className="text-primary-400 hover:text-primary-300 transition-colors duration-200 text-sm inline-flex items-center gap-1 cursor-pointer"
                >
                  View All Services
                  <ChevronRight className="w-4 h-4" />
                </span>
